...
variable "ami" {
  description = "AMI for runner instances"
  type        = string
}

variable "instance_type" {
  description = "Instance type for runners"
  type        = string
}

variable "boot_volume_size" {
  description = "Root volume size (GB) for runners"
  type        = number
}

variable "boot_volume_type" {
  description = "Root volume type for runners"
  type        = string
}


variable "user_data" {
  description = "Path to user data script for runners"
  type        = string
}
